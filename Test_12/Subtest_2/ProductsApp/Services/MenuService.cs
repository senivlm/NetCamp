...
namespace ProductsApp.Services
{
    internal class MenuService
    {
        ...
        private void PrintMeny()
        {
            ...
            Console.WriteLine("3 - пошук продуктiв");
        ...
        private void Menu3()
        {
            List<Product> list = new List<Product> {
               ...
               new Product("Carrot", 12,12),
               new Meat("Pork", 45, 15,new DateTime(2023,05,12), Category.firstSort, Kind.pork),
               new Meat("Pork in pita", 50, 15,new DateTime(2023,05,12), Category.secondSort, Kind.pork),
               new Meat("Pork by Franch", 45, 15,new DateTime(2023,05,12), Category.firstSort, Kind.pork),
               new Meat("Beef", 50, 5,new DateTime(2023,05,12),Category.firstSort, Kind.pork)
            };
            Storage storage = new Storage(list);
            ...
            try
            {
                searchResult = storage.Search(Console.ReadLine());
                Console.WriteLine("Search result:");
                if (searchResult.Count > 0)
                {
                    foreach (Product prod in searchResult) Console.WriteLine(prod);
                }
                else
                {
            ...
            {
                UserService.SendAlertMessage(ex.Message);
            }
